...
public class HttpUtils {
    ...
    private static HttpClient wrapClient(String requestPath) {
    ...
    private static class HttpClientUtils {
        ...
        // 默认连接超时
        private static int defaultConnectTimeout = 180000;
        // 默认读取超时
        private static int defaultReadTimeout = 140000;
        ...
        public static PoolingHttpClientConnectionManager createHttpClientConnectionManager() {
            ...
            try {
                sslConnectionSocketFactory = new SSLConnectionSocketFactory(getSslcontext(), NoopHostnameVerifier.INSTANCE);
            } catch (Exception e) {
